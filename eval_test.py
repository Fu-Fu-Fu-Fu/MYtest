...
def eval_and_plot_for_context_sizes(
    ...
    # 这里只影响 TabPFN 的 eval clone，当前版本你直接用原 regressor，所以实际上没用到
    eval_config = {
        **regressor_config,
        "inference_config": {
    ...
    for k in context_sizes:
        ...
        # ========== 2) TabPFN 预测（基线 & 微调） ==========
        # IMPORTANT: 初始化 base 模型一次，避免第一次没建好 weights
        ...
        save_path = f"./figs/branin_contours_k{k}_with_gp.png"
